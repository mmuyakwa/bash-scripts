...
$SUDO apt-get install filezilla remmina mc screen build-essential software-properties-common gdebi redshift-gtk retext locales-all curl git libavcodec-extra gksudo libavcodec-extra p7zip-full p7zip-rar ffmpeg -y
